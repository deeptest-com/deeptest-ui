...
import { onMounted, computed, ref, watch, unref, onUnmounted, provide, defineProps } from 'vue';
import {onBeforeRouteLeave, useRouter} from 'vue-router';
import { useStore } from 'vuex';
import cloneDeep from "lodash/cloneDeep";

import { Endpoint } from "@/views/endpoint/data";
import EndpointBasicInfo from '@/views/endpoint/components/Drawer/EndpointBasicInfo.vue';
import EndpointDefine from '@/views/endpoint/components/Drawer/Define/index.vue';
import EndpointDebug from '@/views/endpoint/components/Drawer/Debug/index.vue';
import EndpointCases from '@/views/endpoint/components/Drawer/Cases/index.vue';
import EndpointMock from '@/views/endpoint/components/Drawer/Mock/index.vue';
...
const initEndpointDetail = async () => {
  ...
  try {
    await store.dispatch('Endpoint/getEndpointDetail', { id: activeTab.value.entityId });
    // 打开抽屉详情时，拉取mock表达式列表
